...
/innocent, /jail, /kick or /ban

#### Admin Commands:

Use /jail \<playername\> \<reason\> to initiate a trial as discipline for a player.
A reason must be provided.

Use /jail addcell to add a jail cell. The first jail cell can be populated by as many
...
#### Permissions:
 ...
 - noirpvp.jail: allows admins to initiate discipline trials (use /jail \<playername> \<reason>)
